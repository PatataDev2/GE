...
export default function DocxPreview({ blob }) {
  ...
  return (
    <div className="docx-preview-container rounded-lg border border-gray-200 overflow-auto max-h-screen bg-white p-4 relative min-h-screen">
      {loading && !error && (
        <div className="flex justify-center items-center p-12 absolute inset-0 bg-white/90 z-10">
