...
from .views import UserView, RegisterView, Custom_token_obtain_pair_view, CurrentUserView, AdminCreateFuncionarioView, AdminUpdateFuncionarioView, AdminToggleActivoView
